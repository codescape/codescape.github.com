...
Die ABC GmbH hat uns mit der Entwicklung ihrer XYZ-Anwendung beauftragt. Die Anforderungen stehen noch nicht genau fest und doch sollte die Anwendung am besten schon gestern fertig sein. Wie können wir unserem Kunden dennoch helfen sein Problem so schnell wie möglich zu lösen? Agile Softwareentwicklung scheint die Rettung zu sein! Wir wagen die Anforderungsanalyse mittels Specification by Example, befüllen unser Backlog mit den ersten Stories und Akzeptanzkriterien, organisieren uns über das Kanban-Board, implementieren testgetrieben mittels Groovy & Grails und sprinten mit täglichen Daily Scrums durch unsere erste Iteration. Die erste Abnahme erfolgt auf der auf dem Testsystem bereitgestellten Anwendung und mit einer lebhaften Retrospektive beenden wir den ersten Sprint. Die nächste Iteration kann kommen! Dieser Vortrag zeigt lebhaft und interaktiv den agilen Alltag in einem Projekt.
